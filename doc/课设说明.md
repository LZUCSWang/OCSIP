...
- 点击**导入**可以打开文件选择框选择要进行AI推理的图像文件，并会提示导入成功和图像信息
  ...
  ![image-20231223221018521](pic\dataset_import.png)

  ![image-20231223221116746](pic\dataset_import_show.png)

- 点击**上传**后并会加载并在后端进行AI推理并将该图片识别成某一类

  ![image-20231223221204403](pic\dataset_submit_loading.png)
  
  ![image-20231223221248735](pic\dataset_submit.png)

##### 数据管理

- 点击上方各个标签可以切换到对应标签下的所有图像，并且标签栏的切换会伴随切换动画

  ![image-20231223221404796](pic\dataset_switch.png)

- 点击任一图像会在左侧显示该图像对应详细信息

  ![image-20231223221446012](pic\dataset_img_info.png)

- 点击各图像上方的复选框可以勾选图像，并可进一步删除对应图像

  ![image-20231223221539039](pic\dataset_checkbox.png)

  ![image-20231223221622211](pic\dataset_delete_checkbox.png)

- 全选本页可以实现批量删除

  ![image-20231223221647743](pic\dataset_delete_all.png)

  ![image-20231223221709001](pic\dataset_delete_all_.png)

- 其他细节

  - 将鼠标悬浮在右侧标签栏会悬浮显示标签中文信息

    ![image-20231223221853859](pic\dataset_label_zh.png)
